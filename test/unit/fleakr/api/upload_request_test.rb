    ...
    context "An instance of the UploadRequest class" do
      ...
      context "after initialization" do
        ...
        should "know the endpoint_uri" do
          ...
          request.__send__(:endpoint_uri).should == URI.parse('http://innertree-flickr-altlabs.apigee.com/services/upload/')
        end
        
        should "know the endpoint_uri for an :update request" do
          request = UploadRequest.new('filename', :update)
          request.__send__(:endpoint_uri).should == URI.parse('http://innertree-flickr-altlabs.apigee.com/services/replace/')
        end
